...
public class MainActivityTest {
    ...
    public void testActivitySwitch() {
        ...
        // Check if the city name and back button is displayed, this means the activity switched
    ...
    public void testCityNameConsistent() {
        ...
        // Click on city
        onData(is(instanceOf(String.class))).inAdapterView(withId(R.id.city_list)).atPosition(0).perform(click());
        // Check if the activity has the city name from previous activity
    ...
    public void testBackButton() {
        ...
        // Check if city list appears in the screen, this means the activity switched back
